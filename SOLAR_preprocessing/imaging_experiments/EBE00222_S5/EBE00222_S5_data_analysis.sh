# code for experiment EBE00222_s05
# 4 hour hatchling pulse, 14 day chase
# rois: bottom_center_74,bottom_left_75,bottom_right_60,top_center_58,top_left_76,top_right_59
#!/bin/bash
...
preprocess register batch . --codebook=reddot.json --config=config.json --threads=2
...
## create chunks
python /working/fishtools/working/fishtools/fishtools/preprocess/spots/overlay_spots.py .  --codebook=ebe_devprobeset_targets   --seg-codebook=reddot   --overwrite
python /working/fishtools/working/fishtools/fishtools/preprocess/spots/overlay_spots.py . --codebook=ebe_tricycle_targets --seg-codebook=reddot --overwrite
