# code for experiment EBE00219_s03
# 24 hour hatchling pulse, 7 day chase
# rois: big, small
#!/bin/bash
...
preprocess stitch register . --idx=0 --max-proj --codebook=edu --overwrite
preprocess check-shifts . --codebook=codebooks/edu.json
...
## fuse zarr
preprocess stitch fuse . --codebook=edu --overwrite

## segmentation
python /working/fishtools/segmentation/distributed/distributed_segmentation.py . --channels="wga,reddot"
